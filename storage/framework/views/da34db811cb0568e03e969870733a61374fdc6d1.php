...
<body class="body-welcome p-3 center">
    ...
    <form class="container d-flex mt-3 mt-md-3" method="POST" action="<?php echo e(route('register')); ?>">
    <?php echo csrf_field(); ?>
        <!-- Name -->
        <input id="name" placeholder="Nombre Completo" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(url('/')); ?>" class="text-right text-purple form-label-link mt-2">¿Ya tienes cuenta? Inicia sesión</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\Prueba\resources\views/auth/register.blade.php ENDPATH**/ ?>